...
Овај интерактивни приручник ће вам помоћи да савладате основе прогамирања у визуелном програмском језику Скреч. Приручник је прилагођен градиву предмета Информатика и рачунарство за V разред основне школе.

   .. toctree::
      :maxdepth: 2

      Algoritamski-nacin-razmisljanja.rst
